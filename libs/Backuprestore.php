...
//        $stmt = $this->prepare($sql);
    ...
    function backupDatabase($name, $tables = '*') {
        ...
        if (file_exists($fileName)) { 
            ...
            $resultLink = "<a href=" . URL . "$outputArchive target='_blank'>Klik disini untuk men-DOWNLOAD DATABASE</a> atau <a href='" . URL. "admin/del_backup/$zipName.zip'>hapus backup database</a>.";
        }
        echo $resultLink;
    }
